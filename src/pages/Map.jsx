      ...
      <div className="flex flex-col lg:flex-row gap-4 mb-5">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 bg-white border border-[#e0e0e0] rounded-[12px] focus:outline-none focus:ring-2 focus:ring-[#0071e3] focus:border-transparent font-apple-body text-[15px] text-[#1d1d1f] placeholder:text-[#7a7a7a] transition-shadow"
          />
        </div>
      </div>
